...
def median_filt(y):
    return scipy.signal.medfilt(wiener(y),7)
files = librosa.util.find_files('E:\data_voices\head')
for i in files:
    normalise_1(i,'E:\data_voices\head_after\\'+i[20::])
    y,sr=librosa.load('E:\data_voices\head_after\\'+i[20::], sr = 16000)
    y=median_filt(normalise_2(y))
    soundfile.write('E:\data_voices\head_after\\'+i[20::],y, sr)
